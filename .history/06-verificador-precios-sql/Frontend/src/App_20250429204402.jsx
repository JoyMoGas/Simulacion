  ...
  return (
    <div className='container'>
      ...
      <div className='floating-buttons'>
        ...
        <a href='https://github.com/JoyMoGas/Simulacion/blob/main/06-verificador-precios-sql/Frontend/SQL.txt' target="_blank" rel="noopener noreferrer">
          <button className='btn-pj'>
            <p>Ver archivo SQL</p>
          </button>
        </a>
        <a href='https://github.com/JoyMoGas/Simulacion/blob/main/06-verificador-precios-sql/Backend/index.py' target="_blank" rel="noopener noreferrer">
          <button className='btn-pj'>
            <p>Ver código API</p>
          </button>
        </a>
