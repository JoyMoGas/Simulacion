    ...
    <>
      ...
      <div className="btn-row">
        <div className="btn-column">
          <ProjectButton title="8 Reinas" url="https://ocho-reinas-six.vercel.app" subtitle="El problemas de las 8 reinas" />
          <ProjectButton title="Tic-Tac-Toe" url="https://tic-tac-toe-woad-pi-50.vercel.app/" subtitle="Simulacion del juego" />
